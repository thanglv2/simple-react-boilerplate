...
describe('<MovieList />', () => {
  ...
  describe('render()', () => {
    it('should render <BookMark /> WITH call updateBookMark', () => {
      ...
      expect(wrapper.find('i').prop('className')).toEqual('fas fa-bookmark sc-EHOje dlWbKw')
    })
    ...
    it('should render <BookMark /> WITH call saveBookMark', () => {
      ...
      expect(wrapper.find('i').prop('className')).toEqual('fas fa-bookmark sc-EHOje dXkaKP')
    })
  })
